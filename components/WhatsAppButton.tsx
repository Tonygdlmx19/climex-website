...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-40 flex items-center gap-2 rounded-full bg-whatsapp py-3 pl-3 pr-3 text-white shadow-[0_10px_30px_-8px_rgba(37,211,102,.7)] transition-all hover:bg-whatsapp-dark sm:pr-5"
    >
